...
horizonte = 6; % Horizonte de tiempo h
numentradas = 2; %número de parques a incluir en las entradas
...
%     datos_entrenamiento_entrada{i}= [datos_entrenamiento(i+secuenciaSize-1:-1:i,1); datos_entrenamiento(i+secuenciaSize-1:-1:i,2); datos_entrenamiento(i+secuenciaSize-1:-1:i,3); datos_entrenamiento(i+secuenciaSize-1:-1:i,4); datos_entrenamiento(i+secuenciaSize-1:-1:i,5); datos_entrenamiento(i+secuenciaSize-1:-1:i,6); datos_entrenamiento(i+secuenciaSize-1:-1:i,7); datos_entrenamiento(i+secuenciaSize-1:-1:i,8)];
%     datos_entrenamiento_entrada{i}= [datos_entrenamiento(i+secuenciaSize-1:-1:i,1); datos_entrenamiento(i+secuenciaSize-1:-1:i,3); datos_entrenamiento(i+secuenciaSize-1:-1:i,4); datos_entrenamiento(i+secuenciaSize-1:-1:i,8)];
    datos_entrenamiento_entrada{i}= [datos_entrenamiento(i+secuenciaSize-1:-1:i,3);datos_entrenamiento(i+secuenciaSize-1:-1:i,8)];
    datos_entrenamiento_salida = [datos_entrenamiento_salida; datos_entrenamiento(i+secuenciaSize-1+horizonte,8)];
end
...
%     datos_validacion_entrada{i} = [datos_validacion(i+secuenciaSize-1:-1:i,1); datos_validacion(i+secuenciaSize-1:-1:i,2); datos_validacion(i+secuenciaSize-1:-1:i,3); datos_validacion(i+secuenciaSize-1:-1:i,4); datos_validacion(i+secuenciaSize-1:-1:i,5); datos_validacion(i+secuenciaSize-1:-1:i,6); datos_validacion(i+secuenciaSize-1:-1:i,7); datos_validacion(i+secuenciaSize-1:-1:i,8)];
%     datos_validacion_entrada{i} = [datos_validacion(i+secuenciaSize-1:-1:i,1); datos_validacion(i+secuenciaSize-1:-1:i,3); datos_validacion(i+secuenciaSize-1:-1:i,4); datos_validacion(i+secuenciaSize-1:-1:i,8)];
    datos_validacion_entrada{i} = [datos_validacion(i+secuenciaSize-1:-1:i,3); datos_validacion(i+secuenciaSize-1:-1:i,8)];
    datos_validacion_salida = [datos_validacion_salida; datos_validacion(i+secuenciaSize-1+horizonte,8)];
end
...
%     datos_prueba_entrada{i} = [datos_prueba(i+secuenciaSize-1:-1:i,1); datos_prueba(i+secuenciaSize-1:-1:i,2); datos_prueba(i+secuenciaSize-1:-1:i,3); datos_prueba(i+secuenciaSize-1:-1:i,4); datos_prueba(i+secuenciaSize-1:-1:i,5); datos_prueba(i+secuenciaSize-1:-1:i,6); datos_prueba(i+secuenciaSize-1:-1:i,7); datos_prueba(i+secuenciaSize-1:-1:i,8)];
%     datos_prueba_entrada{i} = [datos_prueba(i+secuenciaSize-1:-1:i,1); datos_prueba(i+secuenciaSize-1:-1:i,3); datos_prueba(i+secuenciaSize-1:-1:i,4); datos_prueba(i+secuenciaSize-1:-1:i,8)];
    datos_prueba_entrada{i} = [datos_prueba(i+secuenciaSize-1:-1:i,3); datos_prueba(i+secuenciaSize-1:-1:i,8)];
    datos_prueba_salida = [datos_prueba_salida; datos_prueba(i+secuenciaSize-1+horizonte,8)];
end
...
layers = [ ...
    sequenceInputLayer(num_features*numentradas)
...
predicciones_prueba_originales=predicciones_prueba*sigma(8)+mu(8);
datos_prueba_salida_originales=datos_prueba_salida*sigma(8)+mu(8);
